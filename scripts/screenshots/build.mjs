...
/** Beschriftungen der Bloecke – dieselben Dateien, die der Shop ausliefert. */
const strings = Object.fromEntries(
  ["de", "en", "fr", "es", "it", "nl"].map((lang) => [
    lang,
    json(path.join(localeDir, lang === "en" ? "en.default.json" : `${lang}.json`)),
  ]),
);
...
const shop = {
  ...
  fr: {
    htmlLang: "fr",
    name: "BOUTIQUE MODÈLE",
    nav: ["Nouveautés", "Collection", "Soldes"],
    utility: "Recherche · Compte · Panier (2)",
    collection: "Collection automne 2026",
    collectionSub: "Livraison offerte dès 49 € · Retours sous 30 jours · Garantie légale incluse",
    products: [
      ["Manteau en laine camel", "249,00 €"],
      ["Perceuse-visseuse 18 V", "139,00 €"],
      ["Machine à expresso Classic", "599,00 €"],
      ["Chaussure de trail Pro", "129,00 €"],
    ],
    footer: ["Mentions légales", "Confidentialité", "Rétractation", "CGV", "Livraison"],
    cart: "Panier",
    cartLines: [
      ["Machine à expresso Classic", "599,00 €", "Quantité 1"],
      ["Manteau en laine camel", "249,00 €", "Quantité 1"],
    ],
    subtotal: "Sous-total",
    subtotalValue: "848,00 €",
    checkout: "Commander · 848,00 €",
    pdpTitle: "Perceuse-visseuse 18 V",
    pdpPrice: "139,00 €",
    pdpBuy: "Ajouter au panier",
    pdpShipping: "Livraison en 2 à 4 jours ouvrés",
    producer: "ACME Outils SAS",
    model: "PERC-18 V",
    consumer: "Camille Martin",
    email: "camille.martin@example.fr",
    order: "#1042",
    orderDate: "3 septembre 2026",
    goods: "Manteau en laine camel, taille 50",
    receipt: "WR-20260903-K4TQ7M",
    receivedAt: "3 septembre 2026, 14h07",
  },
  es: {
    htmlLang: "es",
    name: "TIENDA DE MUESTRA",
    nav: ["Novedades", "Colección", "Rebajas"],
    utility: "Buscar · Cuenta · Carrito (2)",
    collection: "Colección otoño 2026",
    collectionSub: "Envío gratis desde 49 € · 30 días de devolución · Garantía legal incluida",
    products: [
      ["Abrigo de lana camel", "249,00 €"],
      ["Taladro atornillador 18 V", "139,00 €"],
      ["Cafetera espresso Classic", "599,00 €"],
      ["Zapatilla de trail Pro", "129,00 €"],
    ],
    footer: ["Aviso legal", "Privacidad", "Desistimiento", "Condiciones", "Envíos"],
    cart: "Carrito",
    cartLines: [
      ["Cafetera espresso Classic", "599,00 €", "Cantidad 1"],
      ["Abrigo de lana camel", "249,00 €", "Cantidad 1"],
    ],
    subtotal: "Subtotal",
    subtotalValue: "848,00 €",
    checkout: "Finalizar compra · 848,00 €",
    pdpTitle: "Taladro atornillador 18 V",
    pdpPrice: "139,00 €",
    pdpBuy: "Añadir al carrito",
    pdpShipping: "Entrega en 2–4 días laborables",
    producer: "ACME Herramientas S.L.",
    model: "TALAD-18 V",
    consumer: "Lucía García",
    email: "lucia.garcia@example.es",
    order: "#1042",
    orderDate: "3 de septiembre de 2026",
    goods: "Abrigo de lana camel, talla 50",
    receipt: "WR-20260903-K4TQ7M",
    receivedAt: "3 de septiembre de 2026, 14:07",
  },
  it: {
    htmlLang: "it",
    name: "NEGOZIO DI ESEMPIO",
    nav: ["Novità", "Collezione", "Saldi"],
    utility: "Cerca · Account · Carrello (2)",
    collection: "Collezione autunno 2026",
    collectionSub: "Spedizione gratuita da 49 € · Reso entro 30 giorni · Garanzia legale inclusa",
    products: [
      ["Cappotto in lana cammello", "249,00 €"],
      ["Trapano avvitatore 18 V", "139,00 €"],
      ["Macchina espresso Classic", "599,00 €"],
      ["Scarpa da trail Pro", "129,00 €"],
    ],
    footer: ["Note legali", "Privacy", "Recesso", "Condizioni", "Spedizione"],
    cart: "Carrello",
    cartLines: [
      ["Macchina espresso Classic", "599,00 €", "Quantità 1"],
      ["Cappotto in lana cammello", "249,00 €", "Quantità 1"],
    ],
    subtotal: "Subtotale",
    subtotalValue: "848,00 €",
    checkout: "Vai alla cassa · 848,00 €",
    pdpTitle: "Trapano avvitatore 18 V",
    pdpPrice: "139,00 €",
    pdpBuy: "Aggiungi al carrello",
    pdpShipping: "Consegna in 2–4 giorni lavorativi",
    producer: "ACME Utensili S.r.l.",
    model: "TRAP-18 V",
    consumer: "Marco Rossi",
    email: "marco.rossi@example.it",
    order: "#1042",
    orderDate: "3 settembre 2026",
    goods: "Cappotto in lana cammello, taglia 50",
    receipt: "WR-20260903-K4TQ7M",
    receivedAt: "3 settembre 2026, 14:07",
  },
  nl: {
    htmlLang: "nl",
    name: "VOORBEELDWINKEL",
    nav: ["Nieuw", "Collectie", "Sale"],
    utility: "Zoeken · Account · Winkelwagen (2)",
    collection: "Herfstcollectie 2026",
    collectionSub: "Gratis verzending vanaf € 49 · 30 dagen retour · Wettelijke garantie inbegrepen",
    products: [
      ["Wollen jas camel", "€ 249,00"],
      ["Accuboormachine 18 V", "€ 139,00"],
      ["Espressomachine Classic", "€ 599,00"],
      ["Trailschoen Pro", "€ 129,00"],
    ],
    footer: ["Colofon", "Privacy", "Herroeping", "Voorwaarden", "Verzending"],
    cart: "Winkelwagen",
    cartLines: [
      ["Espressomachine Classic", "€ 599,00", "Aantal 1"],
      ["Wollen jas camel", "€ 249,00", "Aantal 1"],
    ],
    subtotal: "Subtotaal",
    subtotalValue: "€ 848,00",
    checkout: "Afrekenen · € 848,00",
    pdpTitle: "Accuboormachine 18 V",
    pdpPrice: "€ 139,00",
    pdpBuy: "In winkelwagen",
    pdpShipping: "Levering in 2–4 werkdagen",
    producer: "ACME Gereedschap B.V.",
    model: "BOOR-18 V",
    consumer: "Sanne de Vries",
    email: "sanne.devries@example.nl",
    order: "#1042",
    orderDate: "3 september 2026",
    goods: "Wollen jas camel, maat 50",
    receipt: "WR-20260903-K4TQ7M",
    receivedAt: "3 september 2026, 14:07",
  },
};
