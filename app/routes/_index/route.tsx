...
const T = {
  en: {
    ...
    f6: "The app sets no cookies and tracks nobody. Withdrawal data is stored in a database in Frankfurt, and the privacy policy plus a data-processing section are ready to hand to your lawyer.",
    ...
    a2: "Withdrawal statements, shop data and settings live in a database in Frankfurt, Germany. The application currently runs on Netlify servers in the USA under the EU Standard Contractual Clauses; the live region is shown at /healthcheck. No cookies, no tracking.",
  ...
  de: {
    ...
    f6: "Die App setzt keine Cookies und trackt niemanden. Die Widerrufsdaten liegen in einer Datenbank in Frankfurt, Datenschutzerklärung und Angaben zur Auftragsverarbeitung liegen fertig bereit.",
    ...
    a2: "Widerrufserklärungen, Shop-Daten und Einstellungen liegen in einer Datenbank in Frankfurt am Main. Die Anwendung läuft derzeit auf Netlify-Servern in den USA auf Basis der EU-Standardvertragsklauseln; die aktuelle Region steht unter /healthcheck. Keine Cookies, kein Tracking.",
